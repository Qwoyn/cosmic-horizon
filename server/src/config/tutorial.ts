...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    hint: 'Type "move <sector_id>" using one of the adjacent sector numbers from your look command.',
    triggerAction: 'move',
    triggerCount: 1,
  },
  {
    ...
    hint: 'Move to two more sectors to complete this step.',
    triggerAction: 'move',
    triggerCount: 2,
  },
  {
    ...
    hint: 'Navigate to a sector with an outpost, then type "dock" or "d".',
    triggerAction: 'dock',
    triggerCount: 1,
  },
  {
    ...
    hint: 'While docked, type "buy <commodity> <quantity>" (e.g., "buy food 5").',
    triggerAction: 'buy',
    triggerCount: 1,
  },
  {
    ...
    description: 'Sell commodities at another outpost to earn credits.',
    hint: 'Find another outpost and type "sell <commodity> <quantity>".',
    triggerAction: 'sell',
    triggerCount: 1,
  },
  {
