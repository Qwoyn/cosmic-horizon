...
export const STORE_ITEMS: StoreItem[] = [
  // Mines
  {
    id: 'mine_halberd',
    name: 'Halberd Mine',
    description: 'Explodes on contact, dealing heavy damage to the first ship entering the sector.',
    price: 1500,
    category: 'deployable',
  ...
  // Buoy
  {
    ...
    description: 'Leaves a message visible to all players in the sector. Logs visitors.',
    price: 200,
    category: 'deployable',
    deployableType: 'buoy',
  },
  ...
  },
  {
    id: 'jump_drive',
    name: 'Jump Drive',
    description: 'Enables instant travel to any explored sector (high energy cost).',
    price: 25000,
    category: 'equipment',
  ...
  },
  {
    id: 'rache_device',
    name: 'Rache Device',
    description: 'Self-destruct device. Deals massive damage to all ships in sector when detonated.',
    price: 10000,
    category: 'consumable',
  },
  {
    id: 'cloaking_cell',
    name: 'Cloaking Cell',
    description: 'Single-use cloaking charge. Lasts until you fire weapons or dock.',
    price: 2000,
    category: 'consumable',
  },
  {
